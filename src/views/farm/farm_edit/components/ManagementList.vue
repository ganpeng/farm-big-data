    ...
    <div class="management-list-container">
        ...
        <div class="tabel-field">
            ...
            <el-table header-row-class-name="common-table-header" class="my-table-style" :data="list.data" border>
                ...
                <el-table-column min-width="120px" align="center" label="出资情况">
                    <template slot-scope="scope">
                ...
                <el-table-column width="160px" align="center" label="操作">
                    <template slot-scope="scope">
                        ...
                        <div v-else class="operator-btn-wrapper">
                            <span class="btn-text text-danger" @click="revokeManagementHandler(scope.row.id)">撤销</span>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
...
import {managementList} from '@/mock/member';
export default {
    name: 'ManagementList',
    components: {ManagementDialog},
    data() {
        return {
            searchField: {
                keyword: '',
    ...
    methods: {
        ...
        createManagement() {
            this.$refs.managementDialog.show();
        },
        async submitManagementHandler() {
            try {
        ...
        editManagementHandler(id) {
            let management = _.get(this.list.data, id);
            this.$refs.managementDialog.show(management);
        },
        async deleteManagementHandler() {
            try {
