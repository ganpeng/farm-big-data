    ...
    <div class="revenue-information-container">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="当年营收 元" prop="name">
                        <el-input v-model="data.one"></el-input>
                    </el-form-item>
                    <el-form-item label="当年缴税 元" prop="createdAt">
                        <el-input v-model="data.two"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="当年盈余 元" prop="type">
            ...
            <el-row>
                <el-table
                    ...
                    <el-table-column align="center" prop="area1" label="营收"></el-table-column>
                    <el-table-column align="center" prop="area2" label="盈余"></el-table-column>
                    <el-table-column align="center" prop="area3" label="缴税"></el-table-column>
                    <el-table-column align="center" prop="area4" label="分红"></el-table-column>
                </el-table>
            </el-row>
        </el-form>
    </div>
